...
const T: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "hero.h1a":"Find, evaluate and contract","hero.h1b":"the right suppliers","hero.h1c":"— globally",
    "hero.p":"From Fortune 500 procurement teams to SMBs. AI-powered discovery, 360° supplier profiles, financial risk scoring, and document generation — all in one platform.",
  ...
  sv: {
    ...
    "hero.h1a":"Hitta, utvärdera och kontraktera","hero.h1b":"rätt leverantörer","hero.h1c":"— globalt",
    "hero.p":"Från Fortune 500-inköpsteam till SMF. AI-driven sökning, 360° leverantörsprofiler, finansiell riskbedömning och dokumentgenerering — allt i en plattform.",
  ...
  de: {
    ...
    "hero.h1a":"Finden, bewerten und beauftragen","hero.h1b":"die richtigen Lieferanten","hero.h1c":"— weltweit",
    "hero.p":"Von Fortune-500-Einkaufsteams bis KMU. KI-gestützte Suche, 360°-Lieferantenprofile, finanzielle Risikobewertung und Dokumentenerstellung — alles auf einer Plattform.",
